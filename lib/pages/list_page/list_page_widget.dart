              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 6.0, 0.0),
                    ...
                    children: [
                      Expanded(
                        child: FFButtonWidget(
                          onPressed: () async {
                            setState(() {
                              _model.textController?.text = '#ダラダラ';
                            });
                          },
                          text: 'ダラダラ',
                      ...
                      Expanded(
                        child: FFButtonWidget(
                          onPressed: () async {
                            setState(() {
                              _model.textController?.text = '#ワイワイ';
                            });
                          },
                          text: 'ワイワイ',
                          options: FFButtonOptions(
                      ...
                      Expanded(
                        child: FFButtonWidget(
                          onPressed: () async {
                            setState(() {
                              _model.textController?.text = '#まったり';
                            });
                          },
                          text: 'まったり',
                          options: FFButtonOptions(
