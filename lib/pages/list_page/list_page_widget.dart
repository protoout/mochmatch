                              ...
                              if (FFAppState().disableShoshinshaSearch) {
                                return FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    FFAppState().disableShoshinshaSearch =
                                        false;
                                ...
                                child: FutureBuilder<List<MochmatchDataRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount: listViewMochmatchDataRecordList
                                          .length,
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        functions.calculateDistance(
                                                                            listViewMochmatchDataRecord.location!,
                                                                            currentUserLocationValue!),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
